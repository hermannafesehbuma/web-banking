    ...
    <div className="mx-auto w-full max-w-6xl px-6 py-16 md:py-20">
      ...
      <section className="max-w-3xl">
        ...
        <p className="mt-4 text-muted-foreground">
          We combine deep financial expertise with modern technology to deliver
          secure, fair, and easy-to-use products that help you save, spend, and
      ...
      <section className="mt-16">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card>
            ...
            <CardContent className="pt-0 text-sm">
              Security first. Fair and transparent. Customer-obsessed. Built for
              the long term.
            </CardContent>
          </Card>
        </div>
      ...
      <section className="mt-16">
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base flex items-center gap-2">
                <Scale className="h-5 w-5 text-primary" /> Fair and transparent
              </CardTitle>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base flex items-center gap-2">
                <Handshake className="h-5 w-5 text-primary" /> Customer-obsessed
              </CardTitle>
      ...
      <section className="mt-16">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent className="pt-0 text-sm">
              Member FDIC. We maintain robust KYC/AML procedures and comply with
              applicable regulations in the jurisdictions where we operate.
            </CardContent>
          </Card>
        </div>
      </section>
      ...
      <section className="mt-16">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base flex items-center gap-2">
                <CheckCircle2 className="h-5 w-5 text-primary" /> 99.99% uptime
              </CardTitle>
