...
export default function CookiePage() {
  return (
    <div className="mx-auto w-full max-w-3xl px-6 py-16 md:py-20 prose prose-neutral dark:prose-invert">
      <h1>Cookie Policy</h1>
      <p>
        This Cookie Policy explains how Fortiz Bank, N.A. ("Fortiz") uses
        cookies and similar technologies (collectively, "cookies") when you
        visit our websites or use our applications and Services.
      </p>

      <h2>1. What are cookies?</h2>
      <p>
        Cookies are small text files placed on your device that store
        information about your visit. They are widely used to make websites work
        or function more efficiently, as well as to provide reporting
        information.
      </p>
      ...
      <ul>
        ...
        <li>
          <strong>Performance cookies</strong>: Help us measure and improve site
          performance by understanding how visitors use our Services.
        </li>
        <li>
          <strong>Functional cookies</strong>: Enable enhanced functionality and
          personalization, such as remembering preferences.
        </li>
        <li>
          <strong>Analytics cookies</strong>: Provide aggregated insights about
          usage patterns to improve products and user experience.
        </li>
        <li>
          <strong>Advertising cookies</strong>: May be used to deliver relevant
          ads and measure campaign performance where applicable.
        </li>
      </ul>
      ...
      <p>
        Our Services do not currently respond to "Do Not Track" signals because
