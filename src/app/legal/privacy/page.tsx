...
export default function PrivacyPage() {
  return (
    <div className="mx-auto w-full max-w-3xl px-6 py-16 md:py-20 prose prose-neutral dark:prose-invert">
      ...
      <p>
        This Privacy Policy describes how Fortiz Bank, N.A. ("Fortiz," "we,"
        ...
        banking services (collectively, the "Services"). By using the Services,
      ...
      <p>
        ...
        provide directly to us; (2) information collected automatically; and (3)
        information received from third parties in accordance with applicable
        law.
      </p>
      <h3>1.1 Information you provide</h3>
      <ul>
        <li>
          Account and identity data, such as name, email address, phone number,
          date of birth, government identifiers, and mailing address.
        </li>
        <li>
      ...
      <ul>
        <li>
          Usage data, such as pages viewed, features used, and interactions with
          in-app elements.
        </li>
        <li>
      ...
      <p>
        Where applicable, we rely on the following legal bases: performance of a
        contract; compliance with legal obligations; legitimate interests (e.g.,
        product security and improvement); and consent where required.
      </p>

      <h2>4. How we share information</h2>
      <ul>
        <li>
          With service providers under binding contracts who process data on our
          behalf (e.g., cloud hosting, analytics, customer support).
        </li>
        <li>
      ...
      <h2>6. Security</h2>
      <p>
        We implement organizational, technical, and physical safeguards to help
        protect personal information, including encryption, access controls,
        monitoring, and regular testing. No security method is infallible; users
      ...
      <ul>
        ...
        <li>
          ...
          portability, restriction, objection). Submit requests via our Contact
          page.
        </li>
      </ul>
      ...
      <p>
        ...
        require recipients to protect information in accordance with applicable
        laws.
      </p>
      ...
      <p>
        ...
        our Contact page or by mail to Fortiz Bank, N.A., Attn: Privacy, at our
        listed address.
      </p>
