  ...
  return (
    ...
    <div className="mx-auto w-full max-w-3xl px-6 py-16 md:py-20 prose prose-neutral dark:prose-invert">
      ...
      <p>
        ...
        Fortiz Bank, N.A. ("Fortiz") websites, mobile applications, and banking
        services (collectively, the "Services"). By accessing the Services, you
      ...
      <p>
        ...
        have not been barred from using the Services under applicable laws. You
      ...
      <p>
        ...
        with these Terms and applicable law. You will not interfere with the
        normal operation of the Services, attempt unauthorized access, or use
        the Services in a manner that could harm Fortiz or others.
      </p>

      <h2>4. Fees and rates</h2>
      <p>
        We disclose fees and rates associated with accounts and services in
        product documentation and disclosures. We may update fees with notice as
        required by law. You authorize applicable fees to be debited from your
        accounts.
      </p>
      ...
      <p>
        The Services may link to third-party sites or integrate with third-party
        providers. Fortiz does not control and is not responsible for third
        parties’ content, products, or services.
      </p>

      <h2>8. Intellectual property</h2>
      <p>
        The Services, including content, trademarks, and software, are owned by
        or licensed to Fortiz and protected by law. You receive a limited,
      ...
      <p>
        ...
        A PARTICULAR PURPOSE, AND NON-INFRINGEMENT. THIS DISCLAIMER MAY NOT
        APPLY IN SOME JURISDICTIONS.
      </p>

      <h2>10. Limitation of liability</h2>
      <p>
        TO THE MAXIMUM EXTENT PERMITTED BY LAW, FORTIZ AND ITS AFFILIATES SHALL
      ...
      <p>
        ...
        law. Continued use after changes become effective constitutes acceptance
      ...
      <p>
        ...
        account is opened, without regard to conflicts of law. Disputes will be
        resolved pursuant to the dispute resolution provisions in your account
        agreements, which may include arbitration.
      </p>
